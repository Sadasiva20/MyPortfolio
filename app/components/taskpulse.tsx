...
export default function KanbanBoard() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-900 to-blue-900">
      ...
      <nav className="bg-gray-800 p-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex space-x-4">
            <Button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-sm">
              Settings
            </Button>
            <Button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-sm">
              Profile
          ...
          <div className="space-y-4">
            <div className="text-white">
              ...
              <ul className="space-y-2">
                <li className="hover:bg-gray-700 p-2 rounded-sm cursor-pointer">Overview</li>
                <li className="hover:bg-gray-700 p-2 rounded-sm cursor-pointer">Analytics</li>
                <li className="hover:bg-gray-700 p-2 rounded-sm cursor-pointer">Reports</li>
              </ul>
            </div>
            ...
            <div className="text-white">
              ...
              <ul className="space-y-2">
                <li className="hover:bg-gray-700 p-2 rounded-sm cursor-pointer">Active</li>
                <li className="hover:bg-gray-700 p-2 rounded-sm cursor-pointer">Archived</li>
                <li className="hover:bg-gray-700 p-2 rounded-sm cursor-pointer">+ New Project</li>
              </ul>
            </div>
            ...
            <div className="text-white">
              ...
              <ul className="space-y-2">
                <li className="hover:bg-gray-700 p-2 rounded-sm cursor-pointer">Members</li>
                <li className="hover:bg-gray-700 p-2 rounded-sm cursor-pointer">Calendar</li>
                <li className="hover:bg-gray-700 p-2 rounded-sm cursor-pointer">Messages</li>
              </ul>
            </div>
          </div>
        </div>
                      ...
                      >
                        <Card className="p-4 bg-blue-100 shadow-md rounded-lg cursor-pointer hover:bg-blue-200">
                          <input
                            ...
                            className="w-full p-2 bg-blue-100 text-gray-800 border-2 border-gray-300 rounded-md focus:outline-hidden focus:border-blue-500"
                          />
                        </Card>
                      </motion.div>
                    ))}
